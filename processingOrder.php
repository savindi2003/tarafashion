...
<head>
    ...
    <title>Thara Fashion | My Orders | Processing Orders</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice`  WHERE `user_email`='" . $_SESSION["u"]["email"] . "' AND `status` =  '0' OR `status` = '1'   ORDER BY `date` DESC");
                        ...
                        <div class="col-12 ">
                            <div class="row justify-content-center">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-dark fw-bold" aria-current="page" href="processingOrder.php">Processing</a>
                                    </li>
                                    <li class="nav-item">
