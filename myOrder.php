...
<head>
    ...
    <title>Thara Fashion | My Orders</title>
    ...
    <div class="container-fluid   ">
        <div class="row ">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice`  WHERE   `user_email`='" . $_SESSION["u"]["email"] . "' ORDER BY `date` DESC  ");
                        ...
                        <div class="col-12 ">
                            <div class="row justify-content-center">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link text-dark fw-bold " aria-current="page" href="#">All</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-dark " href="processingOrder.php">Processing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-dark" href="awaitingOrder.php">Awaiting Delivery</a>
                                    </li>
                                                ...
                                                `user_email`='" . $_SESSION["u"]["email"] . "'");
                                                                    ...
                                                                    <div class="col-lg-5 col-12 ">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>
                                                                                <span class="card-text text-danger fw-bold "><i class="bi bi-exclamation-circle text-danger fw-bold"></i>&nbsp;You Canceled your order</span>
                                                                    ...
                                                                    <div class="col-lg-3 col-12 ">
                                                                        ...
                                                                        <div class="row justify-content-center ">
                                                                            ...
                                                                            if ($invoice_data["status"] == 0) {
                                                                            ?>
                                                                                <button class="col-lg-12 col-6 btn btn-sm btn-warning mt-3 mx-2 mb-4 mb-lg-0" onclick="cancelOrder('<?php echo $invoice_data['id']; ?>');">Cancel Order</button>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                ?>
                                                                                <button class="col-5 col-lg-12 btn btn-sm btn-warning mt-3 mx-2 mb-2 mb-lg-0 disabled " >Order Canceled</button>
                                                    ...
                                                    <div class="modal" tabindex="-1" id="feedback<?php echo $invoice_data['product_id']; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Add your Feedback</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row">
                                                                            <div class="col-3">
                                                                                <img src="<?php echo $images_data["path"]; ?>" style="width:100px ; height:100px;" />
                                                                            </div>
                                                                            <div class="col-9 ">
                                                                                <span class=""><?php echo $p_data["title"]; ?></span><br />
                                                                                <span class="" style="font-size:14px;">Rs. <?php echo $p_data["price"];  ?> .00</span><br />
                                                                                <span class="" style="font-size:12px;">Material : <?php echo $met_data["name"]; ?></span><br />
                                                                                <span class="" style="font-size:12px;">Color family : <?php echo $col_data["name"]; ?></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>

                                                                    <div class="col-12 mt-4">
                                                                        <span class="mb-1 ">User's email</span>
                                                                        <input class="form-control " disabled type="email" value="<?php echo $_SESSION["u"]["email"]; ?>" />
                                                                    </div>

                                                                    <div class="col-12 mt-2">
                                                                        <span class=" mb-1">Feedback</span>
                                                                        <textarea class="form-control" cols="50" rows="8" id="feedbacktext"></textarea>
                                                                    </div>

                                                                    <!---img upload---
                                                                <div class="col-12 mt-2">
                                                                    <input type="file" class="d-none" id="orderimg" accept="image/*" multiple />
                                                                    <label for="orderimg" class="btn btn-sm btn-warning mt-5 mb-3" onclick="changeOrderImage();">Upload Images</label>
                                                                        ...
                                                                        <div class="row mx-1 mx-lg-0 ">
                                                                            ...
                                                                            <div class="col-4 d-flex justify-content-center">
                                                                                <div class="row border-1 ">
                                                                                    <img src="resources/emtyimg.png" class="img-thumbnail" alt="..." style="width:100px; height:100px;" id="po0">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-4">
                                                                                <div class="row border-1 d-flex justify-content-center ">
                                                                                    <img src="resources/emtyimg.png" class="img-thumbnail" alt="..." style="width:100px; height:100px;" id="po1">
                                                                                </div>
                                                                            </div>

                                                                            <div class="col-4">
                                                                                <div class="row border-1 d-flex justify-content-center ">
                                                                                    <img src="resources/emtyimg.png" class="img-thumbnail" alt="..." style="width:100px; height:100px;" id="po2">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-outline-warning fw-bold" data-bs-dismiss="modal">Close</button>
                                                                    <button type="button" class="btn btn-outline-warning fw-bold" onclick="savefeedback(<?php echo $invoice_data['product_id']; ?>)">Save </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
