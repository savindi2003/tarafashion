    ...
    <div class="container-fluid   ">
        <div class="row ">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice`  WHERE `user_email`='" . $_SESSION["u"]["email"] . "'  AND `status` =  '4' ORDER BY `date` DESC");
                        ...
                        <div class="col-12 ">
                            <div class="row justify-content-center">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-dark fw-bold " aria-current="page" href="#">Completed</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
