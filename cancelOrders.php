    ...
    <div class="container-fluid   ">
        <div class="row ">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice`  WHERE `user_email`='" . $_SESSION["u"]["email"] . "'  AND `status` =  '5' ORDER BY `date` DESC");
                        ...
                        <div class="col-12 ">
                            <div class="row justify-content-center">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-dark fw-bold ">Cancel Orders</a>
                                    </li>
                                    <li class="nav-item">
                                                ...
                                                `user_email`='" . $_SESSION["u"]["email"] . "'");
                                                                    ...
                                                                    <div class="col-lg-3 col-12 ">
                                                                        ...
                                                                        <div class="row justify-content-center ">
                                                                            ...
                                                                            if ($invoice_data["status"] == 5) {
                                                                            ?>
                                                                                <button class="col-5 col-lg-12 btn btn-sm btn-warning mt-3 mx-2 mb-2 mb-lg-0 " onclick="removeCanceledOrder(<?php echo $invoice_data['id']; ?>);">Remove</button>
