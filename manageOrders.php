            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row mt-2 mb-2" style="background-color: rgb(46,46,46) ;">
                        <span class="h2 text-light text-start fw-bolder"> Selling Details</span>
                    </div>
                ...
                <div class="col-12 pt-3 mb-1 bg-dark">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-light"><a href="sellingHistory.php" style="font-size:12px;">Selling History</a></li>
                ...
                <div class=" col-5 offset-1 d-flex justify-content-center ">
                    <input type="text" name="search" placeholder="Search.." class="search bg-dark text-light   pt-2 pb-2 rounded-end mb-2 mt-2" style="border-radius:30px ; height:30px; font-size:12px;" id="os">
                    <span class="input-group-text rounded-start mb-2 mt-2" style="border-radius:30px ;  font-size:12px; height:30px;" onclick="searchOrder();"><i class="bi bi-search"></i></span>
                </div>
                ...
                <div class="col-2">
                    <label class="btn btn-light btn-sm mt-2" style="border-radius:30px ;" onclick="findSellings1();">Find Order</label>
                </div>

                <div class="col-12 mt-4" id="view_area6">
                    <div class="row " style=" overflow-y: scroll; height:560px;">
                        ...
                        <div class="col-12 mt-3   ">
                            <div class="row ">
                                ...
                                <div class="col-4 col-lg-1 mb-1  py-2" style="background-color: rgb(46,46,46) ;">
                                ...
                                <div class="col-2  y py-2 mb-1  " style="background-color: rgb(46,46,46) ;">
                                ...
                                ?>
                                    ...
                                    <div class="col-12  ">
                                        <div class="row ">
                                            <div class="col-2 col-lg-1 py-2  mb-1">
                                            ...
                                            ?>
                                            <div class="col-4 col-lg-2  py-2" style="background-color: rgb(46,46,46) ;">
                                            ...
                                            <div class="col-4 col-lg-1  py-2" style="background-color: rgb(46,46,46) ;">
                                            ...
                                            <div class="col-2  y py-2 " style="background-color: rgb(46,46,46) ;">
                                                <div class="row text-end">
                                                    <span class=" text-white ">
                                                        <?php
                                                        if ($o_data["status"] == 0) {
                                                        ?>
                                                            <button class="btn col-12 btn-dark btn-sm fw-bold mt-1 mb-1" style="font-size:12px;" onclick="changeInvoiceStatus('<?php echo $o_data['id']; ?>');" id="btn<?php echo $o_data["id"]; ?>">Confirm Order</button>
                                                        <?php
                                                        } else if ($o_data["status"] == 1) {
                                                        ?>
                                                            <button class="btn col-12 btn-dark btn-sm fw-bold mt-1 mb-1" style="font-size:12px;" onclick="changeInvoiceStatus('<?php echo $o_data['id']; ?>');" id="btn<?php echo $o_data["id"]; ?>">Packing...</button>
                                                        <?php
                                                        } else if ($o_data["status"] == 2) {
                                                        ?>
                                                            <button class="btn col-12 btn-dark btn-sm fw-bold mt-1 mb-1" style="font-size:12px;" onclick="changeInvoiceStatus('<?php echo $o_data['id']; ?>');" id="btn<?php echo $o_data["id"]; ?>">Dispatch...</button>
                                                        <?php
                                                        } else if ($o_data["status"] == 3) {
                                                        ?>
                                                            <button class="btn col-12 btn-dark btn-sm fw-bold mt-1 mb-1" style="font-size:12px;" onclick="changeInvoiceStatus('<?php echo $o_data['id']; ?>');" id="btn<?php echo $o_data["id"]; ?>">Shipping...</button>
                                                        <?php
                                                        } else if ($o_data["status"] == 4) {
                                                        ?>
                                                            <button class="btn col-12 btn-dark btn-sm fw-bold mt-1 mb-1" style="font-size:12px;" onclick="changeInvoiceStatus('<?php echo $o_data['id']; ?>');" id="btn<?php echo $o_data["id"]; ?>">Deliverd</button>
                                                        <?php
                                                        }
                                                        ?>
                                                    </span>
